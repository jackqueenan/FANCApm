...
- ***batch-file***: .csv/.tsv batch file containing the following variables 
  ...
  - optional ***print-orientation-equivalents***: When print-variants=TRUE, print the orientation-equivalent variants (reverse-complements) instead of biological variants. 
